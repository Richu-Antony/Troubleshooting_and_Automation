...
<head>
	...
	<!--======== Title ===========-->
	<title>DUORL: Admin Home</title>
	<link rel="icon" href="https://localhost/Duorl_Automation_&_Troubleshooting_Website/IMAGES/lightning.png" type="image/x-icon">
	<!--======= Style Sheet =======-->
...
<body>
	...
	<footer>simple php filemanager by <a href="#">Richu Antony</a></footer>
</body>
